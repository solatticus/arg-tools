...
using static Arg.Tools.QRCodeGenerator;
...
namespace Arg.Tools
{
    public class QRCode : AbstractQRCode, IDisposable
    {
        ...
        //{
        //    return this.GetGraphic(pixelsPerModule, System.Drawing.ColorTranslator.FromHtml(darkColorHtmlHex), ColorTranslator.FromHtml(lightColorHtmlHex), drawQuietZones);
        //}
